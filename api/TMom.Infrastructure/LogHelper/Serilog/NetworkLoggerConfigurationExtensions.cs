...
namespace TMom.Infrastructure.LogHelper
{
    ...
    public static class NetworkLoggerConfigurationExtensions
    {
        ...
        {
            // 读取相关配置
            LogConfigRootDTO logConfigRootDTOInfo = null;// JsonConfigUtils.GetAppSettings<LogConfigRootDTO>(AppSettingsFileNameConfig.AppSettingsFileName, "LogFiedOutPutConfigs");
